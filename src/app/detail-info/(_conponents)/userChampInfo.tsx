  ...
  export const UserChampInfo = () => {
    ...
    return (
      <div className="flex w-[332px] h-[1000px] rounded-lg bg-neutral-800">
        <div className="flex w-full h-[100px] p-[12px] gap-x-10">
            ...
            <div className="flex w-[50px] h-[100px]">
              <span>{tierData[0].wins}</span>
              <span>{tierData[0].losses}</span>
            </div>
